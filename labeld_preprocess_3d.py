...
# Original file path
path_mat = r'E:\DeepLearning\Exp\data\original\Labeled\IndianPines\Indian_pines_corrected.mat'

# Set path of output data
path_scaled_ip = r'E:\DeepLearning\Exp\data\ing\3d\ip\Indian_pines_corrected_interp_scaled.npy'

# Path of input label value
path_lab_mat = r'E:\DeepLearning\Exp\data\original\Labeled\IndianPines\Indian_pines_gt.mat'
# Path of output label value
hyper_lab_str = r"E:\DeepLearning\Exp\data\original\Labeled\IndianPines\lable.npy"

# Paths of files containing spectral information for spectral resampling
path_ip_spec = r'E:\DeepLearning\Exp\data\original\IndianPines.csv'
path_interp_spec = r'E:\DeepLearning\Exp\data\original\pos_3d_180.csv'

# Set path of output data
path_batches = r'E:\DeepLearning\Exp\data\ing\3d\ip'

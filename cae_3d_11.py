...
path_unlab_patches = r"E:\DeepLearning\Exp\data\ing\3d\hyper\unlabel_patches.npy"
...
x = Conv3D(4, (9, 3, 3), activation='relu', padding='same', data_format = "channels_first")(input_img)
...
x = Conv3D(4, (9, 3, 3), activation='relu', padding='same', data_format = "channels_first")(x)
decoded = Conv3D(1, (9, 3, 3), activation='sigmoid', padding='same', data_format = "channels_first")(x)

...
This file is for 2d-convolutional networks.
...
# Set path patches
path_ip_2d = r"M:\DeepLearning\Exp\data\ing\180\ip\2d_conv"

# Path of input patches
path_ip_patches = os.path.join(path_ip_2d, "patches_ip_2d.npy")
...
np.save(os.path.join(path_ip_2d, 'training_2d_conv_x.npy'), x_train)
np.save(os.path.join(path_ip_2d, 'training_2d_conv_y.npy'), y_train)
np.save(os.path.join(path_ip_2d, 'validation_2d_conv_x.npy'), x_test)
np.save(os.path.join(path_ip_2d, 'validation_2d_conv_y.npy'), y_test)
